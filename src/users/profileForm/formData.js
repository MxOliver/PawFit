export const adopterInfoFields = [
  {
    fieldname: "Name",
    fieldId: "adopterName",
    fieldType: "text"
...
export const adopterReferences = [
  {
